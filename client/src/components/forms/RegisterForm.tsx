...
const RegisterForm = () => {
	...
	const submitRegistrationForm = (
		...
		oneOrganizer: RegisterOrganizer,
		successCallback: Function,
	) => {
		event.preventDefault();
		axios
			.post(process.env.REACT_APP_SERVER_URL + '/api/organizers/register', oneOrganizer)
	...
	return (
		<Box
			...
			onSubmit={(event: React.FormEvent) =>
				submitRegistrationForm(event, oneOrganizer, redirectAfterSuccessfulRegistration)
			}
		>

...
OrganizerSchema.virtual('password')
    ...
    .set( function(this: IOrganizer, value: string ){ this._password = value})

    OrganizerSchema.virtual('confirmPassword')
    .get( function(this: IOrganizer) {
        return this._confirmPassword })
    .set( function(this: IOrganizer, value: string ){ this._confirmPassword = value})
